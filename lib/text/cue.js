...
shaka.text.Cue = class {
  ...
  /**
   * Return true if cue1 comes before cue2 according to webvtt format or if
   * both cue1 and cue2 are same.
   *
   * @param {shaka.text.Cue} cue1
   * @param {shaka.text.Cue} cue2
   * @returns {boolean}
   */
  static lessThanOrEqualTo(cue1, cue2) {
    return (cue1.startTime < cue2.startTime)
        || (cue1.startTime === cue2.startTime && cue1.endTime === cue2.endTime
